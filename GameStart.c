...
int GameStart(void) {
	...
	while (Flame == 0) {
		...
		gotoxy(Difficulty_cusorX, Difficulty_cusorY - 1);    printf("                                      ");
		gotoxy(Difficulty_cusorX, Difficulty_cusorY);		 printf("             난이도 선택              ");
		gotoxy(Difficulty_cusorX, Difficulty_cusorY + 1);	 printf("                                      ");
		gotoxy(Difficulty_cusorX, Difficulty_cusorY + 2);	 printf("               1. 쉬움                ");
		gotoxy(Difficulty_cusorX, Difficulty_cusorY + 3);	 printf("               2. 보통                ");
		gotoxy(Difficulty_cusorX, Difficulty_cusorY + 4);	 printf("               3. 어려움              ");
		gotoxy(Difficulty_cusorX, Difficulty_cusorY + 5);    printf("                                      ");
