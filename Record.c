...
void ShowRecord() {
	...
	gotoxy(Record_cusorX, Record_cusorY - 1);    printf("                                       ");
	gotoxy(Record_cusorX, Record_cusorY);		 printf("               랭킹 선택               ");
	gotoxy(Record_cusorX, Record_cusorY + 1);	 printf("                                       ");
	gotoxy(Record_cusorX, Record_cusorY + 2);	 printf("               1. 쉬움                 ");
	gotoxy(Record_cusorX, Record_cusorY + 3);	 printf("               2. 보통                 ");
	gotoxy(Record_cusorX, Record_cusorY + 4);	 printf("               3. 어려움               ");
	gotoxy(Record_cusorX, Record_cusorY + 5);    printf("               4. 레벨모드             ");
	gotoxy(Record_cusorX, Record_cusorY + 6);    printf("                                       ");
